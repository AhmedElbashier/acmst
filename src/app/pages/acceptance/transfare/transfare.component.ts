...
@Component({
  selector: 'app-transfare',
  templateUrl: './transfare.component.html',
  styleUrls: ['./transfare.component.css']
})
export class TransfareComponent implements OnInit {
...
searchcomplete()
{
  ...
  transfare()
  {
        ...
        this.studantService.transfare(this.student.id,this.program,this.stdclass);
